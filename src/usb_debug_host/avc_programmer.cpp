                              ...
                              std::string &error)
{
    ...
    const std::filesystem::path readback =
        ...
        (L"avc-rblhost-readback-" + std::to_wstring(GetCurrentProcessId()) + L"-" +
                        ...
                        std::string &error)
{
    ...
    else
    {
        ...
        add_environment("AVC_PROGRAMMER_PATH");
        ...
        add_environment("AVC_RBLHOST_PATH");
        add_environment("AVC_BLHOST_PATH");

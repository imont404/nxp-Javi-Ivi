...
$exe = Join-Path $outDir "avc_tool.exe"
$pdb = Join-Path $outDir "avc_tool.pdb"
$coreObject = Join-Path $outDir "avc_host_core.obj"
$programmerObject = Join-Path $outDir "avc_programmer.obj"
$toolObject = Join-Path $outDir "avc_tool.obj"
$coreSource = Join-Path $scriptDir "avc_host_core.cpp"
$programmerSource = Join-Path $scriptDir "avc_programmer.cpp"
$toolSource = Join-Path $scriptDir "avc_tool.cpp"
...
Write-Host "Building AVC native host tool ($Configuration)..."

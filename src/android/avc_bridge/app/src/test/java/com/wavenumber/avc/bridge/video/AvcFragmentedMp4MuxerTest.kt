...
class AvcFragmentedMp4MuxerTest {
    ...
    fun writesMseInitializationAndLengthPrefixedMediaFragment() {
        val muxer = AvcFragmentedMp4Muxer()
        val initialization = muxer.initialization(AvcH264FormatView(sps, pps))
        ...
        val fragment = muxer.fragment(
            AvcH264AccessUnitView(7, 99, 0, true, byteArrayOf(0, 0, 0, 1) + nal),
        )

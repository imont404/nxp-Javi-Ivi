...
data class AvcMp4Initialization(
    val bytes: ByteArray,
    val codecConfig: Int,
)

data class AvcMp4Fragment(
    val frameId: Long,
    val capturedNs: Long,
...
class AvcFragmentedMp4Muxer(
    ...
    fun initialization(format: AvcH264FormatView): AvcMp4Initialization {
    ...
    fun fragment(accessUnit: AvcH264AccessUnitView): AvcMp4Fragment {
        val sample = annexBToAvcc(accessUnit.bytes)
    ...
    private fun annexBToAvcc(source: ByteArray): ByteArray {
    ...
    private fun Mp4Writer.box(type: String, body: Mp4Writer.() -> Unit) = bytes(this@AvcFragmentedMp4Muxer.box(type, body))

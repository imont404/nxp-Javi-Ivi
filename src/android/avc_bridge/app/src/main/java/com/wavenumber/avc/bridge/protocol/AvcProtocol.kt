...
data class AvcPacket(
    val header: AvcPacketHeader,
    val payload: ByteArray,
)

object AvcControlPacketBuilder {
    fun build(
        sequence: Int,
        messageId: Int,
        arg0: Int = 0,
        arg1: Int = 0,
        arg2: Int = 0,
    ): ByteArray = ByteBuffer.allocate(AvcProtocol.HEADER_BYTES)

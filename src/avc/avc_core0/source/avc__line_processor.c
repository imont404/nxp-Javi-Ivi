 ...
 */
const uint32_t avc_rgb565_yhsv_lut[AVC_RGB565_COLOR_LUT_ENTRY_COUNT] = {
#include "avc_rgb565_yhsv_lut.inc"
};
                                 ...
                                 uint32_t length)
{
    ...
    {
        output[i] = avc__rgb565_to_yhsv(input[i]);
    }
}
                               ...
                               uint32_t length)
{
    for (uint32_t i = 0; i < length; i++)
    {
        output[i] = avc__rgb565_to_yhsv(input[i]).y;
    }
}

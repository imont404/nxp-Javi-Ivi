...
def main() -> int:
    ...
    parser.add_argument("--project-dir", default="src/embedded/nxp_cup_core0", help="MCUXpresso project directory")
    ...
    lines = [
        ...
        "#   .\\src\\embedded\\tools\\maintainer\\build_cmake.ps1 -CheckDrift",
        "#   .\\src\\embedded\\tools\\maintainer\\build_cmake.ps1 -Regenerate",
        "",

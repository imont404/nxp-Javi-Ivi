...
def write_markdown(
    ...
    lines = [
        ...
        "- Current firmware pin mux: `src/embedded/nxp_cup_core0/board/pin_mux.c`",
        "- Current camera setup: `src/embedded/nxp_cup_core0/source/nxpc_io/bv_camera__interface.c`",
        "",
        "## Initial Conclusion",
        "",

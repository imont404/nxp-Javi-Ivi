param(
    ...
    [string]$Workspace = (Join-Path (Resolve-Path (Join-Path $PSScriptRoot "..\..")) ".mcux_workspace_headless"),
    [string]$ProjectPath = (Join-Path (Resolve-Path (Join-Path $PSScriptRoot "..\..")) "src\nxp_cup\nxp_cup_core0")
)

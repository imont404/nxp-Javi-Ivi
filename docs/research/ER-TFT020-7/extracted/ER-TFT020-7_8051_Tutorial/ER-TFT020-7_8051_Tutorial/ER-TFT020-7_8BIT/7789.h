...
//=============================================================
//Define lcd io
sbit CS=P1^0;		//Chip select input pin (¡°Low¡± enable).
sbit RS=P1^1;		//RS=A0    RS=1  data   RS=0  command             
sbit _WR=P1^2;		 //8080:write  
sbit _RD=P1^3;		 //8080:read  
sbit RES=P2^6;		//Chip reset pin (¡°Low Active¡±).

#define LDATABUS	P0                  //L BYTE DATA P0

 ...
 */
/*
 * Templating Engine applicable for ROM preset file template processing.
 ...
 *    var finalText = new TemplateEngine().generate(template, options);
 */
TemplatingEngine = function() {
    ...
    self.generate = function(template, options){
        ...
        // execute assembled code and return the result

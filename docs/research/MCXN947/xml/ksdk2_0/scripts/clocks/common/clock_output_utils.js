...
var OutputUtils = {
  ...
  WriteFunctionInit(cfg, indentLevel, fieldID, fieldName, isLast, formatOptions) {
    var tmp = this.getField(cfg, fieldID, "", formatOptions);
    if (fieldName == null || fieldName == "") {
    ...
    CWriter.line(Array(indentLevel).join(" ") + fieldName + "(" + tmp.value + ");" + Array(indentLevel).join(" "), tmp.description);
  },
